...
test("bundle validator requires exactly five unique opportunities",()=>{const good={reference_summary:"summary",commercial_intent:"use",policy_notes:[],opportunities:[1,2,3,4,5].map(String).map(x=>item(x))};assert.equal(validateBundle(good).ok,true);const bad={...good,opportunities:[item("1"),item("2"),item("3"),item("4"),item("4")]};assert.equal(validateBundle(bad).ok,false)});
